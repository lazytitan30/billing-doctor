...
import { GOOGLE_RULES, googleRule, READ_ON, READ_ON_DEVICE, READ_ON_FIELD } from '../dist/google/docs.js';

// The 93 rule ids of BRIEF section 5, by group.
...
test('there are 93 rule ids and each has a Google fact', () => {
  assert.equal(RULE_IDS.length, 93);
