...
- The rules: 63 in ten groups, each resting on a sentence from Google's documentation, read on a stated date. `billing-doctor rules` lists them; `billing-doctor rule B1` prints one.
